...
def write_osm2city_script(block):
    ...
    f.write("PATH_TO_SCENERY = \"/home/dello/Projects/FGScenery_development/MidAtlantic/output\"\n")
    f.write("PATH_TO_OUTPUT = \"/home/dello/Projects/FGScenery_development/MidAtlantic/output\"\n")
    ...
    f.write("export FG_ROOT=/home/dello/SlackBuilds/games/FlightGear-data-next/flightgear-fgdata\n")
    ...
    f.write("/home/dello/Projects/FGScenery_tools/osmosis-latest/bin/osmosis --read-pbf " +
            "file=../midatlantic.osm.pbf --bounding-box completeWays=yes " +
